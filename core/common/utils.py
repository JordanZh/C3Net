...
def regularize_image(x, image_size=512, mode='train'):
    ...
    if mode == 'train':
        ...
        raise ValueError("Mode must be 'train', 'test' or 'inference'.")

    x = transforms(x)
    return x * 2 - 1  # range in [-1.0, 1.0]
