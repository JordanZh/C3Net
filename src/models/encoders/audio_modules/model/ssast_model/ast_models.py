...
class ASTModel(nn.Module):
    def __init__(self, label_dim=527,
        ...
        assert timm.__version__ == '0.4.5', 'Please use timm == 0.4.5, the code might not be compatible with newer versions.'  # FIXME
    ...
    def finetuningavgtok(self, x):
        ...
        #TODO: Maybe I need do something better here
